...
class MasterViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let object = objects[indexPath.row] as? [String: Any] {
            cell._imageView.image = UIImage(named: object["imageName"] as! String)
            cell.titleLabel.text = object["title"] as? String
            cell.likeCounterLabel.text = String(object["likeCount"] as! Int)
            cell.reviewCounterLabel.text = String(object["reviewsCount"] as! Int)
            cell.descLabel.text = object["description"] as? String
            cell.setStarCount(object["starCount"] as! Int)
        }
